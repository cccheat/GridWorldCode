...
public class Critter extends Actor {
	 ...
	 * this critter from its grid if <code>loc</code> is <code>null</code>. An
	 * actor may be added to the old location. If there is a different actor at
	 * location <code>loc</code>, that actor is removed from the grid. Override
	 * this method in subclasses that want to carry out other actions (for
	 * example, turning this critter or adding an occupant in its previous
	 * location). <br />
