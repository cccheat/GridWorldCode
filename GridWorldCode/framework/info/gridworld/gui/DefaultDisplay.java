...
public class DefaultDisplay implements Display {
	...
	/**
	 * Draw the given object. This implementation draws a string with a
	 * background color. The background color is the value of the color
	 * property, or, if there is no such property and the object is an instance
	 * of Color, the object itself. The string is the text property, or if there
	 * is no such property, the result of calling toString. The string is
	 * clipped to 8 characters.
	 * 
	 * @param obj
	 ...
	 * @param fontHeight
	 *            the desired height of the font. (The font will be shrunk in
