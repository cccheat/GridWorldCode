...
public abstract class AbstractDisplay implements Display {
	 ...
	 * the occupant facing North in a cell of size (1,1) centered around (0,0)
	 * on the drawing surface. (All scaling/rotating has been done beforehand).
	 * 
	 * @param obj
	 *            the occupant we want to draw
	 * @param comp
